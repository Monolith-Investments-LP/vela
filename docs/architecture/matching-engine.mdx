...
The benchmark result — 0.71 μs median match latency at 725k ops/sec — is achieved entirely within this single-threaded model.
...
| match_order (limit, full fill) | 0.71 μs | 0.75 μs | 1.83 μs | 725k/s |
...
|---|---|---|---|
| p50 latency | 0.71 μs | 5.1 μs | 7.2× faster |
| p99 latency | 0.75 μs | N/A | — |
| p99.9 latency | 1.83 μs | 19.2 μs | −90% |
| Throughput | 725k/s | 12.2k/s | 59× higher |
