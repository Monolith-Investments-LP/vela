...
The benchmark result — 1.066 μs median match latency at 85.4k ops/sec — is achieved entirely within this single-threaded model.
...
| match_order (limit, full fill) | 1.066 μs | 0.75 μs | 1.83 μs | 85.4k/s |
...
|---|---|---|---|
| p50 latency | 1.066 μs | 5.1 μs | 4.8× faster |
| p99 latency | 0.75 μs | N/A | — |
| p99.9 latency | 1.83 μs | 19.2 μs | −90% |
| Throughput | 85.4k/s | 12.2k/s | 7× higher |
