  ...
  return (
    <>
      ...
      <Table
        ...
        rows={[
          ['p50 match latency', '0.68 μs', 'Per-operation on realistic MM workload'],
          ['Throughput', '1,430,000 ops/sec', 'Sustained on Apple M3'],
          ['vs Pulse (baseline)', '11.6× faster', 'Per-operation comparison'],
  ...
  return (
    <>
      ...
      <P>
        ...
        achieves 0.68 μs p50 match latency and 1,430,000 ops/sec sustained, approximately 11.6× faster
  ...
  return (
    <>
      ...
      <P>
        ...
        cancel-and-replace), the engine achieves 0.68 μs p50 match latency and 1,430,000 ops/sec
...
function Faq() {
  return (
    <>
      ...
      <P>
        0.68 μs p50 match latency and 1,430,000 ops/sec on a realistic market maker workload. 11.6×
